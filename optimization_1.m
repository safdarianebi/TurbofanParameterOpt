...
name_1={'OPR=10  B=3' 'OPR=10  B=6' 'OPR=10  B=9' 'OPR=10  B=12' 'OPR=10  B=15';...
        'OPR=15  B=3' 'OPR=15  B=6' 'OPR=15  B=9' 'OPR=15  B=12' 'OPR=15  B=15';...
        'OPR=20  B=3' 'OPR=20  B=6' 'OPR=20  B=9' 'OPR=20  B=12' 'OPR=20  B=15';...
        'OPR=25  B=3' 'OPR=25  B=6' 'OPR=25  B=9' 'OPR=25  B=12' 'OPR=25  B=15';};
        
name_2={'OPR=10' 'OPR=15' 'OPR=20' 'OPR=25'};
...
if mod(B(j),3)==0 && mod(TIT(k),100)==0 && B(j)<=15 && TIT(k)<=2000
      ...
      figure(2*n-1+(i-1)*10);
      legend('TIT=1000','TIT=1100','TIT=1200','TIT=1300','TIT=1400','TIT=1500','TIT=1600','TIT=1700','TIT=1800','TIT=1900','TIT=2000');
      figure(2*n+(i-1)*10);
      legend('TIT=1000','TIT=1100','TIT=1200','TIT=1300','TIT=1400','TIT=1500','TIT=1600','TIT=1700','TIT=1800','TIT=1900','TIT=2000');
...
figure(5*length(OPR)*2+length(OPR)+1);
legend('OPR=10','OPR=15','OPR=20','OPR=25');
